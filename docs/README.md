...
This folder contains OctoAcme's project management process documents. These docs capture how we initiate, plan, execute, release, and improve project work so teams can deliver predictable, measurable outcomes.
...
- octoacme-execution-and-tracking.md — day-to-day execution rhythms and tracking
- octoacme-risks-and-communication.md — risk register and stakeholder comms
...
- Use the templates and checklists here when starting or running a project.
- Propose doc updates via the "Add Content to Project Management Process Docs" issue template in .github/ISSUE_TEMPLATE/.

If anything here should be reworded or expanded, please review and propose edits in a PR.
